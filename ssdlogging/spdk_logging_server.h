...
//#define DISRUPTOR_LOGGING_QUEUE
//#define MAX_LOGGING_WRITE_SIZE (1024*16)
...
class SPDKLoggingServer {
 ...
 private:
  ...
  rocksdb::DisruptorQueue<LoggingRequest *> *submission_queue;
#else
...
#ifdef DISRUPTOR_LOGGING_QUEUE
    submission_queue = new rocksdb::DisruptorQueue<LoggingRequest *>();
#else
